...
We've made significant improvements to our 2FA implementation, starting with **[email verification for TOTP-based logins](/posts/2025-11-14-login-verification/)**. This adds an extra layer of security to your account by requiring you to confirm your login from a trusted device, when using a phishable 2FA method like TOTP.
...
*   **Phishing Protection:** To combat the ongoing threat of phishing attacks, PyPI now [detects and warns users about untrusted domains](/posts/2025-07-28-pypi-phishing-attack/).
*   **Improved ZIP file security:** We've hardened our upload pipeline to [prevent a class of attacks involving malicious ZIP files](/posts/2025-08-07-wheel-archive-confusion-attacks/).
...
*   **Domain Resurrection Prevention:** We now periodically check for expired domains to [prevent domain resurrection attacks](/posts/2025-08-18-preventing-domain-resurrections/).
*   **Spam Prevention**: We've taken action against spam campaigns, including [prohibiting registrations from specific domains](/posts/2025-06-15-prohibiting-inbox-ru-emails/) that were a source of abuse.
...
*   An issue with [privileges persisting in organization teams](/posts/2025-04-14-incident-report-organization-team-privileges/).
*   A widespread [phishing attack targeting PyPI users](/posts/2025-07-31-incident-report-phishing-attack/).
*   A [token exfiltration campaign via GitHub Actions workflows](/posts/2025-09-16-github-actions-token-exfiltration/).
*   The potential implications of the ["Shai-Hulud" attack on the npm ecosystem](/posts/2025-11-26-pypi-and-shai-hulud/).
...
*   **Project Lifecycle Management:** You can now [archive your projects](/posts/2025-01-30-archival/) to signal that they are no longer actively maintained. This is part of a larger effort to standardize [project status markers as proposed in PEP 792](/posts/2025-08-14-project-status-markers/).
*   **New Terms of Service:** We've introduced a new [Terms of Service](/posts/2025-02-25-terms-of-service/) to formalize our policies and enable new features like organizations.
