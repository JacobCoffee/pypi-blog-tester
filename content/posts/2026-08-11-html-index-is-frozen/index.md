...
authors:
- woodruffw
description: PyPI has adopted PEP 833, which "freezes" the HTML representation of the index API. New packages and releases will continue to appear in the HTML representation, but future standardization and development efforts will focus on the JSON representation.
tags:
- apis
- integrations
published: true
