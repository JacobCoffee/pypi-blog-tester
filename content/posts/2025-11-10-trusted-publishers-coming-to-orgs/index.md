...
- security
published: true
fediverseCreator: '@miketheman@hachyderm.io'
---

Trusted Publishing has proven popular since [its launch in 2023](/posts/2023-04-20-introducing-trusted-publishers/).
...
Also in 2024, more platforms were added as detailed in our [April 2024 blog post](/posts/2024-04-17-expanding-trusted-publisher-support/).
...
![Monthly File Uploads to PyPI via Trusted Publishers vs Non-Trusted Publishers](./files_added_to_pypi.svg)
...
![Monthly File Uploads to PyPI via Trusted Publishers vs Non-Trusted Publishers, stacked](./files_added_to_pypi_pct.svg)
...
Using that action adds [Digital Attestations](/posts/2024-11-14-pypi-now-supports-digital-attestations/) automatically. :lock:
