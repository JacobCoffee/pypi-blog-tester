...
![Screenshot detailing the history of domain name registration for `pypihosted.org`. The domain was created on February 3, 2024 and the nameservers were updated three times. The domain was then dropped on March 18, 2024.](./screenshot-pypihosted.png)
![Screenshot detailing the history of domain name registration for `pythanhosted.org`. The domain was created on March 15, 2024. The domain was then dropped on April 4, 2024.](./screenshot-pythanhosted.png)
...
Read about how we've [evolved malware reporting](/posts/2024-03-06-malware-reporting-evolved/)
to bring the security community closer to PyPI Administrators.

There's still a lot of work to do in this space,
and [we're hiring a Support Specialist](/posts/2024-03-20-announcing-a-pypi-support-specialist/)
