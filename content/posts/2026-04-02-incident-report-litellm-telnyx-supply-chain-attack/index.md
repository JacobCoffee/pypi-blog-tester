...
![LiteLLM download timeline with reports and quarantine](./litellm_downloads_timeline.png)

During the window of attack, the exploited versions of `litellm` were downloaded over 119k times.

PyPI received 13 inbound reports from concerned users, leveraging the ["Report project as malware" feature](/posts/2024-03-06-malware-reporting-evolved/), added back in 2024, accelerating the review/action.
...
![Telnyx download timeline with reports and quarantine](./telnyx_downloads_timeline.png)
...
[PyPI has required 2FA to be enabled to publish packages](/posts/2024-01-01-2fa-enforced/) since the beginning of 2024,
